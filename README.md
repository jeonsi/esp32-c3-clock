...
|---|---|---|
| 짧게 1회 | 디지털 ↔ 아날로그 | — |
| 짧게 2회 (1초 내) | 12시간제 ↔ 24시간제 | `12시간제` / `24시간제` |
...
- 클릭은 마지막 클릭 후 1초(`DOUBLE_CLICK_MS`) 동안 추가 클릭이 없을 때 반영됩니다(1회=화면, 2회=12/24h, 3회=뮤트) — 클릭 사이 간격도 1초까지 인정됩니다. 뮤트를 해제하면 확인용 비프가 한 번 울립니다
...
| `DOUBLE_CLICK_MS` | 1000 | 연속 클릭으로 인정할 클릭 간 최대 간격. 마지막 클릭 후 이 시간이 지나야 동작이 반영됨 |
